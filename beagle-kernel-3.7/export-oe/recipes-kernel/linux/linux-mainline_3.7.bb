...
SRCREV_pn-${PN} = "8a69ca20f06d1878aa0ee8000a60d8226ab6b6a1"

SRC_URI = " \
	git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git;branch=linux-3.7.y \
	...
	file://pinctrl/0005-pinctrl-pinctrl-single-Fix-the-pins-debug-output.patch \
	...
	file://omap/0002-regulator-core-if-voltage-scaling-fails-restore-orig.patch \
	...
	file://omap_beagle_expansion/0011-Beagle-expansion-LSR-COM6L-Adapter-Board-also-initia.patch \
	...
	file://omap_beagle/0005-ARM-OMAP-Beagle-C4-fix-reboot-problem.patch \
	...
	file://omap_sgx/0002-Revert-OMAPDSS-Remove-old-way-of-setting-manager-and.patch \
	file://omap_sgx/0003-arm-Export-cache-flush-management-symbols-when-MULTI.patch \
	...
	file://capes/0001-da8xx-fb-add-Chalk-Electronics-LVDS-cape-and-10in-di.patch \
	file://defconfig \
"
